...
implementors["check_graphite"] = [{"text":"impl FromStr for Assertion","synthetic":false,"types":[]}];
implementors["check_procs"] = [{"text":"impl FromStr for Signal","synthetic":false,"types":[]}];
...
implementors["tabin_plugins"] = [{"text":"impl FromStr for Stat","synthetic":false,"types":[]},{"text":"impl FromStr for State","synthetic":false,"types":[]},{"text":"impl FromStr for WorkSource","synthetic":false,"types":[]},{"text":"impl FromStr for Calculations","synthetic":false,"types":[]},{"text":"impl FromStr for MemInfo","synthetic":false,"types":[]},{"text":"impl FromStr for LoadAvg","synthetic":false,"types":[]},{"text":"impl FromStr for Status","synthetic":false,"types":[]}];
