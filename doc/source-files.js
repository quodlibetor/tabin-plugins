...
sourcesIndex['check_container_cpu'] = {"name":"","dirs":[],"files":["check-container-cpu.rs"]};
sourcesIndex['check_container_ram'] = {"name":"","dirs":[],"files":["check-container-ram.rs"]};
sourcesIndex['check_cpu'] = {"name":"","dirs":[],"files":["check-cpu.rs"]};
sourcesIndex['check_disk'] = {"name":"","dirs":[],"files":["check-disk.rs"]};
sourcesIndex['check_fs_writeable'] = {"name":"","dirs":[],"files":["check-fs-writeable.rs"]};
sourcesIndex['check_graphite'] = {"name":"","dirs":[],"files":["args.rs","assertions.rs","graphite.rs","main.rs"]};
sourcesIndex['check_load'] = {"name":"","dirs":[],"files":["check-load.rs"]};
sourcesIndex['check_procs'] = {"name":"","dirs":[],"files":["check-procs.rs"]};
sourcesIndex['check_ram'] = {"name":"","dirs":[],"files":["check-ram.rs"]};
...
sourcesIndex['crossbeam'] = {"name":"","dirs":[],"files":["arc_cell.rs","lib.rs","ms_queue.rs","seg_queue.rs","sharded_lock.rs","treiber_stack.rs","wait_group.rs"]};
...
sourcesIndex['derive_more'] = {"name":"","dirs":[],"files":["add_assign_like.rs","add_like.rs","constructor.rs","from.rs","from_str.rs","into.rs","lib.rs","mul_assign_like.rs","mul_like.rs","not_like.rs","utils.rs"]};
...
sourcesIndex['proc_macro2'] = {"name":"","dirs":[],"files":["lib.rs","macros.rs","stable.rs","strnom.rs"]};
...
sourcesIndex['scan_fmt'] = {"name":"","dirs":[],"files":["lib.rs","parse.rs"]};
...
sourcesIndex['tabin_plugins'] = {"name":"","dirs":[{"name":"procfs","dirs":[{"name":"pid","dirs":[],"files":["cmd_line.rs","mod.rs","stat.rs"]}],"files":["mod.rs"]}],"files":["lib.rs","linux.rs","scripts.rs","sys.rs"]};
...
sourcesIndex['tokio_sync'] = {"name":"","dirs":[{"name":"mpsc","dirs":[],"files":["block.rs","bounded.rs","chan.rs","list.rs","mod.rs","unbounded.rs"]},{"name":"task","dirs":[],"files":["atomic_task.rs","mod.rs"]}],"files":["lib.rs","loom.rs","oneshot.rs","semaphore.rs"]};
